...
Полная установка с пустого накопителя описана в [02 — Заводская установка](02-factory-installation.md). Она является штатным способом подготовки серийного устройства. Этот документ фиксирует уже установленный runtime.
