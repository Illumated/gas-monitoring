...
Локальный kiosk обращается к loopback без Basic Authentication. Удалённый пользователь проходит nginx authentication, а редактирование Node-RED дополнительно защищено собственным bcrypt-паролем.
