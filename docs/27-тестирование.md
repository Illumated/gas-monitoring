...
Аппаратный FAT, параметры команд и evidence описаны в [08 — Аппаратный FAT](08-аппаратный-fat.md); подписываемая форма находится в [28 — Протокол FAT](28-протокол-аппаратного-fat.md).
