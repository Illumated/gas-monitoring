...
| Проверка | Результат |
|---|---|
| Flow audit | 40 объектов, SHA-256 `AFD834EE0350B684E6911AECEEB063030E7BAAFE3808AACE8C69AF81C4AE5A4D` |
...
После пересборки monitoring повторно проверен в Chrome при viewport 1366×768 и 1920×1080. В обоих случаях размер документа и рабочей области равен viewport, внешней рамки и прокрутки нет; короткий заголовок и отдельная плашка времени отображаются корректно. Engineering ранее проверен при 1366×768; строки идентификации и поля сервисной формы отображаются корректно.
