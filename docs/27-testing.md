...
- runtime-flow содержит цикл `2000 ms`, задержку очереди `300 ms` и опрос только отмеченных в UI каналов; фактический интервал для наборов из 3, 4 и 5 каналов проверяется FAT;
