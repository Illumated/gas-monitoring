...
<section class="current-panel"><div class="gs-title"><div><h2>Токовые входы WB-MAI6</h2><p>Фактический ток петли, обновление в реальном времени</p></div></div><div class="current-grid"><article v-for="input in ['IN1P','IN2P','IN3P','IN4P','IN5P']" :key="input" :class="currentClass(input)"><strong>{{input}}</strong><span>{{currentValue(input)}}</span><small>{{currentStatus(input)}}</small></article></div></section>
