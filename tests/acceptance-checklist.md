...
- [x] HMI и уведомления содержат Debian hostname установки, объект и расположение из persistent сервисных настроек.
...
- [ ] Проверены обрывы всех отмеченных в сервисном UI петель; неактивные каналы на Dashboard отсутствуют.
- [ ] При установленной опции проверены K1 WB‑MR3LV/I и обратная связь IN6P.
